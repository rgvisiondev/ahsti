      ...
      <div className="max-w-[1140px] w-full py-10 mx-auto justify-center flex flex-col gap-5 flex flex-col">
        <div className="w-full text-center">
          ...
          <div className="flex justify-center w-full">
            <div className="gap-10 mt-10 w-full flex flex-col lg:flex-row">

              <div className="flex w-full flex-col items-center">
                <div className="relative w-full h-[490px] lg:h-[400px] bg-[url('/team/bg.png')] bg-cover bg-no-repeat bg-bottom flex justify-center items-bottom overflow-hidden">
                  <Image
                    src="/team/test.png"
                    alt="Test Image"
                    width={400}
